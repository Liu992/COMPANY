const en_US = {
    ...
    "protocol-2":"TOP GLOBAL [Terms of Service] (hereinafter referred to as 'the Terms of Service') is concluded jointly by you and TOP GLOBAL. This Term of Service is valid. Please read carefully and fully understand the contents of the clauses, especially the clauses exempting or restricting TOP GLOBAL from liability (hereinafter referred to as 'exemption clause'), the clauses restricting the access of daughters'rights (hereinafter referred to as 'restriction clause'), the clauses concerning dispute settlement and judicial jurisdiction, and the registration and use of a daughters' household. A separate protocol for the item service. The foregoing exemptions, restrictions, dispute resolution and jurisdictional provisions may be bold in bold, colour-coded or otherwise combined to bring to your attention. Your confirmation of this clause may result in your passivity, inadequacy and loss under certain circumstances. Please read the above clause again before confirming your consent to this clause or before making use of the services and products provided by TOP GLOBAL. Both parties confirm that you have read this clause carefully, that you are aware of and accept the preconditions for the services and products provided by this Clause for you to enable TOP GLOBAL, and that you agree with the legality and validity of this clause.",
    "protocol-3":"Unless you have read and accepted all the contents of this clause, you are entitled to any services provided by TOP GLOBAL.",
    "protocol-4":"You click ‘Agree’, or you register as a subscriber of TOP GLOBAL, or you use the service provided by TOP GLOBAL, as if you have read and agreed to sign this clause.",
    "protocol-5":"This applies to any service you provide to TOP GLOBAL and to use TOP GLOBAL, including but not limited to websites and mobile applications we provide. If you represent an organization and not personally use the Service, you represent and warrant that (a) the organization is a legal institution that complies with local laws and regulations, and (b) you have the right to accept the terms on behalf of the institution and that the organization promises: your The act is an act of the organization and if you violate this clause, the agency agrees to be responsible for your actions.",
    ...
    "protocol-8":"2. You also guarantee that you are not on any list of trade or economic sanctions, such as the UN Security Council sanctions list. In addition, TOP GLOBAL may not provide this service in all countries or regions, and may or may not provide this service to users in restricted areas.",
    "protocol-9":"Therefore, if you do not meet these requirements, do not use our services.",
    "protocol-10":"Second, [create an account]",
    "protocol-11":"1. You need to create a TOP GLOBAL account before using TOP GLOBAL. The TOP GLOBAL account should be registered with the mobile number binding. You have the right to choose whether to become a TOP GLOBAL user, and once you complete the registration, you agree and accept all of the terms of this article.",
    "protocol-12":"2. It is your responsibility to keep the keys, certificates, passwords, access codes, user IDs or other credentials and login information (collectively referred to as “passwords”) that TOP GLOBAL has provided to you, or to generate them by using the Services. The above password, and do a confidential job to prevent your password from being stolen. TOP GLOBAL will not be liable for any loss or damage caused by the unauthorized use of your password by any third party.",
    "protocol-13":"3. All information published by users in various forms on the TOP GLOBAL website shall comply with the relevant laws and regulations and the relevant provisions of the website, conform to the public order and good customs, and do not infringe the legitimate rights and interests of any third party subject, otherwise use The user bears all legal consequences arising therefrom and TOP GLOBAL has the right to recover the losses suffered by the user.",
    "protocol-14":"Third, [user information]",
    "protocol-15":"1. You may need to fill in or submit some necessary personal information during the process of registering your account or using the services and products provided by TOP GLOBAL. TOP GLOBAL User personal information collected in accordance with the law refers to information that complies with laws, regulations and relevant regulations and meets the following scope: (1) Personal information provided to TOP GLOBAL when users register TOP GLOBAL;",
    "protocol-16":"(2) User's browser or mobile client data, including but not limited to IP address, automatically received and recorded by the TOP GLOBAL network when the user uses the TOP GLOBAL service, participates in website activities or accesses the website network. , the information in the website cookie and the network records requested by the user;",
    "protocol-17":"(3) Other TOP GLOBAL User personal information obtained through legal channels.",
    "protocol-18":"2. If the information you submit is incomplete or does not comply with the relevant laws and regulations, you may not be able to use the services and products provided by TOP GLOBAL or be limited in the process of using the services and products provided by TOP GLOBAL. If the personal information you provide is false, incomplete, inaccurate or even misleading, all losses and legal liabilities arising therefrom are your sole responsibility.",
    "protocol-19":"Fourth, [privacy protection]",
    "protocol-20":"1. TOP GLOBAL respects the privacy of users. TOP GLOBAL will take all necessary steps to ensure the security of your personal information and to prevent the leakage, destruction or loss of personal information collected by users during the provision of services.",
    "protocol-21":"2. TOP GLOBAL undertakes not to disclose or disclose your personal information to any third party without the consent of the user. Except for the following specific situations:",
    ...
    "protocol-23":"(2) The leakage of any personal information caused by the user's notification of the password or sharing the registered account and password with others, or other personal privacy information that is not caused by TOP GLOBAL reasons;",
    ...
    "protocol-28":"1. Under this clause, we grant you limited, non-exclusive, non-transferable licenses to access and use the TOP GLOBAL website and services for the sole purpose of approval of the TOP GLOBAL license. You agree that you may not copy, distribute, distribute, sell, license, reverse engineer, modify, post or participate in the transfer or sale of derivative works in any other manner, or use any TOP GLOBAL content in any other way. .",
    "protocol-29":"2. You read and agree to:",
    "protocol-30":"(1) All rights, ownership and benefits of all services and related software, websites and technologies provided by TOP GLOBAL, including all intellectual property rights therein, are TOP GLOBAL;",
    ...
    "protocol-32":"(3) All services and related software, websites and technologies provided by TOP GLOBAL are protected by copyright and other intellectual property laws. TOP GLOBAL reserves all rights not expressly granted under this clause.",
    "protocol-33":"6. [Service Fees]",
    "protocol-34":"When the user uses the service, the website has the right to charge the user for the service fee according to the corresponding rules. TOP GLOBAL has the right to make and adjust service fees. The specific service charges are based on the announcement of the charging method listed on the TOP GLOBAL website or the other written agreement between the user and TOP GLOBAL. .",
    "protocol-35":"Seven, [modification of the terms]",
    "protocol-36":"TOP GLOBAL reserves the right to change or modify the content contained in these Terms at any time, including but not limited to any policies or guidelines on this website. The changed terms will automatically expire after the new terms become effective. If you choose to continue using this website, you accept such changes, if you do not agree, please stop using this website immediately.",
    "protocol-37":"Eight, [disclaimer]",
    "protocol-38":"1. The user fully understands and agrees that TOP GLOBAL's services are provided in accordance with the current state of the art and conditions. TOP GLOBAL will do its utmost to provide services to users to ensure continuity and security; however, TOP GLOBAL cannot always anticipate and guard against legal, technical and other risks, including but not limited to force majeure, viruses, Services such as hacking, hacking, system instability, third-party services, national laws, regulations, policies, and orders from state agencies and other government actions may result in service interruptions, data loss, and other losses and risks. .",
    "protocol-39":"2. TOP GLOBAL shall not be liable for damages if the system platform cannot operate normally due to the following conditions, and the user cannot use the services or cannot be properly entrusted. The situation includes but is not limited to:",
    "protocol-40":"(1) During the system shutdown maintenance period announced by the TOP GLOBAL platform;",
    "protocol-41":"(2) The telecommunication equipment fails to transmit data;",
    "protocol-42":"(3) Due to force majeure factors such as Taiwan, earthquakes, sea tsunami, floods, blackouts, wars, terrorist attacks, etc., the TOP GLOBAL platform system obstacles cannot perform business;",
    ...
    "protocol-46":"3. Unless the TOP GLOBAL Network expressly agrees in writing, the TOP GLOBAL Network provides the User with any content information obtained from the Site in any way (including but not limited to inclusion, via, connection or download), including but TOP GLOBAL is not responsible for any products, services, information or materials purchased or acquired by users due to the content information on this website. The user is solely responsible for the risks caused by the use of the information content of this website.",
    "protocol-47":"4. The user comments published by all users in the TOP GLOBAL network represent only the personal opinions of the users. It does not mean that the website agrees with its opinions or confirms its description. This website does not assume any laws arising from user comments. responsibility. Any legal liability arising from your comments is at your own risk, and at the same time causing losses to TOP GLOBAL, you shall also bear all direct or indirect losses resulting from TOP GLOBAL.",
    "protocol-48":"5. TOP GLOBAL Network does not assume legal responsibility for any activities or information such as winnings or offers that are not obtained through the formal channels of TOP GLOBAL.",
    "protocol-49":"6. You fully understand and agree that TOP GLOBAL will endeavour to ensure the accuracy of the information and content on the Website, but TOP GLOBAL makes no commitment to the accuracy of the above information and content provided on this website. The information and content on the website are subject to change without prior notice from TOP GLOBAL. Any information and content posted on the website does not represent TOP GLOBAL's point of view, and is solely to assist you in making an independent decision, and you have full and independent decision.",
    "protocol-50":"Nine, [restrictions]",
    "protocol-51":"Users are prohibited from using the TOP GLOBAL Network in any form as a place, platform or medium for engaging in various illegal activities. Users may not maliciously register TOP GLOBAL website accounts by any means, including but not limited to multiple account registrations for profit, speculation, cashing, and awards. If the user violates the above provisions, TOP GLOBAL has the right to take all necessary measures directly, including but not limited to deleting the content posted by the user, canceling the star rating, honor and virtual property obtained by the user on the website, suspending or Seize the user account, cancel the benefits derived from the violations, and even pursue the user's legal liability through litigation.",
    "protocol-52":"X. [Dispute Resolution]",
    "protocol-53":"If there is any dispute or dispute between you and TOP GLOBAL, you should first settle it through friendly negotiation. If the negotiation fails, you confirm and agree to submit the dispute or dispute to the jurisdiction of the TOP GLOBAL website.",
    ...
    "protocol-57":"If you have any complaints, feedback or questions, please contact our customer service at service@TOP GLOBAL.io. When you contact us, please provide your name and email address and other information we may need to identify you, as well as the transaction information you are asking about or the complaint.",
    ...
    "center-tip": "Your account is currently not authenticated with a real name, and parts of TOP GLOBAL functionality will not be available to you.",
    "center-btn": "VERIFY",
